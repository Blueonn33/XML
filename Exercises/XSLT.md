...
За да направим XML данните достъпни за всички видове браузъри, можем да трансформираме XML документа на Сървъра и да го изпратим обратно към браузъра като XHTML

## Решение за различни браузъри

В предишната секция бе обяснено как XSLT може да се използва за трансформиране на документ от XML в XHTML в браузър

За бъдат XML данните достъпни за всички видове браузъри, можем да трансформираме XML документа на сървъра и да го изпратим обратно към браузъра като XHTML.
